...
class PautasAbertasViewController: UIViewController, Alertable {
    ...
    func settingLayout(){
        ...
        self.title = Translate.translate("pautas_abertas")
        self.lblDescripiton.text = Translate.translate("pautas_abertas_detalhes")
    ...
    private func bind(to viewModel: DefaultListaPautasViewModel){
        viewModel.pautasAbertas.observe(on: self) { _ in self.reloadData() }
    ...
    private func reloadData(){
        isOpened = Array(repeating: false, count: viewModel.pautasAbertas.value.count)
    ...
    @objc func finalizarPauta(sender: MDCButton){
        viewModel.finalizarPauta(at: sender.tag)
    }
}

extension PautasAbertasViewController: UITableViewDataSource, UITableViewDelegate {
    ...
    func tableView(_ tableView: UITableView, numberOfRowsInSection section: Int) -> Int {
        return viewModel.pautasAbertas.value.count
    }
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        let item = viewModel.pautasAbertas.value[tag]
        let isOpen = isOpened[tag]
        
        cell.btnPauta.tag = tag
        cell.btnPauta.addTarget(self, action: #selector(finalizarPauta(sender:)), for: .touchUpInside)
